...
Manages paid extension subscriptions with Vision Wallet API integration
"""
import aiohttp
import json
...
# Vision Wallet API
VISION_WALLET_API = "https://api.visionwallet.com.br/api/v1"
VISION_WALLET_API_KEY = "vp_64cb694c8ba029030d25f4dccd3f52d4df12f9e94898ef51acda913afa648cd0"  # API Key da Vision Wallet
...
def _get_db_path(extension_id: str = None) -> str:
    ...
    if extension_id == "boost":
        return "database/extensions/visionboost/subscriptions.json"
