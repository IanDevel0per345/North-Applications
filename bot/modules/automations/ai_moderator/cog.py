...
class EditPromptModal(disnake.ui.Modal):
    def __init__(self):
        ...
        super().__init__(title="Editar Configurações do Vision Moderator", components=components)
...
# {emoji.vision}
-# Painel > Automações > **Vision Moderator**
    ...
    def PainelCargoImune() -> list[disnake.ui.Container]:
        ...
        return [
            disnake.ui.Container(
                disnake.ui.TextDisplay(f"""
# {emoji.vision}
-# Painel > Automações > Vision Moderator > **Cargo Imune**
                """),
                disnake.ui.Separator(spacing=disnake.SeparatorSpacing.small),
    ...
    def PainelPrompt() -> list[disnake.ui.Container]:
        ...
        return [
            disnake.ui.Container(
                disnake.ui.TextDisplay(f"""
# {emoji.vision}
-# Painel > Automações > Vision Moderator > **Prompt**
                """),
                disnake.ui.Separator(spacing=disnake.SeparatorSpacing.small),
