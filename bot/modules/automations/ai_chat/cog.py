...
class SetPromptModal(disnake.ui.Modal):
    def __init__(self, channel_id: int):
        ...
        super().__init__(title="Configurar Prompt do VisionAI Chat", components=components)
...
# {emoji.vision}
-# Painel > Automações > **VisionAI Chat**
    ...
    def PainelAdicionarChat() -> list[disnake.ui.Container]:
        ...
        return [
            disnake.ui.Container(
                disnake.ui.TextDisplay(f"""
# {emoji.vision}
-# Painel > Automações > VisionAI Chat > **Adicionar Chat**
                """),
                disnake.ui.Separator(spacing=disnake.SeparatorSpacing.small),
                disnake.ui.ActionRow(
    ...
    def PainelEditarChat(inter: disnake.Interaction) -> list[disnake.ui.Container]:
        ...
        return [
            disnake.ui.Container(
                disnake.ui.TextDisplay(f"""
# {emoji.vision}
-# Painel > Automações > VisionAI Chat > **Editar Chat**
                """),
                disnake.ui.Separator(spacing=disnake.SeparatorSpacing.small),
                disnake.ui.ActionRow(
                    disnake.ui.Select(
    ...
    def PainelConfigurarChat(inter: disnake.Interaction, channel_id: int) -> list[disnake.ui.Container]:
        ...
        return [
            disnake.ui.Container(
                disnake.ui.TextDisplay(f"""
# {emoji.vision}
-# Painel > Automações > VisionAI Chat > **Configurar**
                """),
                disnake.ui.Separator(spacing=disnake.SeparatorSpacing.small),
                disnake.ui.TextDisplay(resumo),
                disnake.ui.Separator(spacing=disnake.SeparatorSpacing.small),
    ...
    def PainelCargoImune() -> list[disnake.ui.Container]:
        ...
        return [
            disnake.ui.Container(
                disnake.ui.TextDisplay(f"""
# {emoji.vision}
-# Painel > Automações > VisionAI Chat > **Cargo Imune**
                """),
                disnake.ui.Separator(spacing=disnake.SeparatorSpacing.small),
    ...
    def PainelMudarCanal(inter: disnake.Interaction, old_channel_id: int) -> list[disnake.ui.Container]:
        ...
        return [
            disnake.ui.Container(
                disnake.ui.TextDisplay(f"""
# {emoji.vision}
-# Painel > Automações > VisionAI Chat > **Mudar Canal**
                """),
                disnake.ui.Separator(spacing=disnake.SeparatorSpacing.small),
                disnake.ui.ActionRow(
                    disnake.ui.ChannelSelect(
    ...
    async def on_ai_chat_message(self, message: disnake.Message):
        ...
        async with message.channel.typing():
            base_prompt = (
                "Você é VisionAI, uma assistente virtual amigável e prestativa da Vision Applications. "
                "Seu papel é oferecer suporte inicial aos usuários, respondendo às dúvidas de forma clara, concisa e natural.\n\n"
                "### Regras Invioláveis:\n"
                "- **Identidade:** Você é uma assistente virtual chamada VisionAI.\n"
                ...
                "Nunca se descreva como 'IA', 'chatbot' ou 'modelo de linguagem'. Você é a VisionAI, um modelo da Vision Applications. "
