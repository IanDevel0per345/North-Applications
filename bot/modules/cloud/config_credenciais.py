...
def CredentialsView_components() -> list[disnake.ui.Container]:
    ...
    explanation = (
        "Para utilizar os serviços da **VisionCloud**, é necessário um **bot exclusivo** que realiza a conexão com nossa **API**, permitindo que os **membros do seu servidor autorizem-o** de forma segura e integrada.\n\n"
        ...
        "`https://cloud.visionapplications.com.br/api/auth/callback`"
    )
    ...
    container = disnake.ui.Container(
        disnake.ui.TextDisplay(f"# {emoji.vision}\n-# Painel > VisionCloud > **Configurar Credenciais**"),
