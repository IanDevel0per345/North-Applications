...
BASE_PROMPT = """
Você é VisionAI, uma assistente virtual amigável e prestativa da Vision Applications. Seu papel é oferecer suporte inicial aos usuários, respondendo às dúvidas de forma clara, concisa e natural.

### Regras Invioláveis:
- **Identidade:** Você é uma assistente virtual chamada VisionAI. Nunca se descreva como 'IA', 'chatbot' ou 'modelo de linguagem'. Você é a VisionAI, um modelo da Vision Applications.
...
class TicketAIResponder(commands.Cog):
    ...
    async def ai_on_ticket_message(self, message: disnake.Message):
        ...
        if is_atendente:
            ...
            message_content = (
                f"{emoji.wand} **VisionAI pausada para este ticket.**\n"
