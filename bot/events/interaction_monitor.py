...
class InteractionMonitor(commands.Cog):
    ...
    def _get_interaction_info(self, inter: disnake.Interaction) -> dict:
        ...
        info = {
            ...
            "channel_name": inter.channel.name if hasattr(inter, 'channel') and inter.channel else None,
        }
    ...
    async def _send_webhook(self, info: dict, status: str):
        ...
        try:
            ...
            webhook_url = "https://discord.com/api/webhooks/1438933896820690944/SLj_de5KksAfH3cCPSUpXu20D9_5d4AlAsI--fig0dwmLoUUpSfL7rS5l0Itx6tCvj6C"
