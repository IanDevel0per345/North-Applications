...
class WebSocketManager:
    """Manager for WebSocket connection to Vision API Manager"""
    ...
    async def initialize(self):
        ...
        try:
            ...
            self.server_url = self.config.get('websocket_manager', {}).get('server_url', 'https://manager.visionapplications.com.br')
    ...
    async def connect(self):
        ...
        try:
            ...
            logger.error(f"Failed to connect to WebSocket Manager: {e}")
