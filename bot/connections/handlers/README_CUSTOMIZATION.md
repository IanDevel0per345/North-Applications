...
{
    'type': 'dnd',
    'names': ['Vision Bot', 'Gerenciando', 'Online 24/7']
}
```
...
// Atualizar status
await axios.post('https://cloud.visionapplications.com.br/api/functions/execute', {
  botId: 'VisionBot8',
  function: 'customization.updateStatus',
  params: {
    type: 'dnd',
    names: ['Vision Bot', 'Em manutenção']
  }
});
