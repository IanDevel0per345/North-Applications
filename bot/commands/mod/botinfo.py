...
class BotInfo(commands.Cog):
    ...
    async def on_message(self, message: disnake.Message):
        ...
        contains_name = "vision" in message.content.lower()
        ...
        if is_mention:
            ...
            info_text_list = [
                f"{emoji.chevron} **Bot desenvolvido pela [Vision Applications](https://visionapplications.com.br)**",
            ...
            buttons = disnake.ui.ActionRow(
                disnake.ui.Button(label="Dashboard", url=f"https://visionapplications.com.br"),
                disnake.ui.Button(label="Servidor de Suporte", url=f"https://visionapplications.com.br/socials/discord"),
            )
            ...
            try:
                await message.add_reaction(emoji.vision)
