...
class Remove(commands.Cog):
    ...
    @commands.slash_command(name="remover", description="Remover recursos", guild_ids=[utils.obter_server_principal()])
    ...
    async def remover_cargo_user(self, inter: disnake.ApplicationCommandInteraction, cargo: disnake.Role, membro: disnake.Member):
        ...
        try:
            await membro.remove_roles(cargo, reason=f"[Vision] Removido por {inter.user}")
