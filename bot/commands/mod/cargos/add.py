...
class Add(commands.Cog):
    ...
    @commands.slash_command(name="adicionar", description="Adicionar recursos", guild_ids=[utils.obter_server_principal()])
    ...
    async def adicionar_cargo_user(self, inter: disnake.ApplicationCommandInteraction, cargo: disnake.Role, membro: disnake.Member):
        ...
        try:
            await membro.add_roles(cargo, reason=f"[Vision] Adicionado por {inter.user}")
